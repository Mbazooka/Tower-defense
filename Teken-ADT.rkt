...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;    
    ...
    (define (bepaal-tegel-positie! positie tegel) ;; Misschien later als hulpprocedure definieren (afhankelijk implementatie dynamische zaken)
    ...
    (define (initialiseer-statisch-posities-scherm! positie object-bitmap object-laag) 
      (let ((tegel-van-object (make-tile 20 20 object-bitmap)))
        (bepaal-tegel-positie! positie tegel-van-object)
        ((object-laag 'add-drawable!) tegel-van-object)))
        ...
        (define (hulp-teken-pad! ctr)
          (if (not (= ctr (pad 'lengte)))
              (begin
                ...
                (initialiseer-statisch-posities-scherm! (vector-ref pad-posities (+ ctr 1)) *bitmap-pad* laag-pad)
                (initialiseer-statisch-posities-scherm! (vector-ref pad-posities (+ ctr 2)) *bitmap-pad* laag-pad)
                (hulp-teken-pad! (+ ctr 3)))))
        (hulp-teken-pad! 0)))
